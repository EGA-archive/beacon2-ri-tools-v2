...
def generate(dict_properties):
    ...
    with open("files/definitions/datasets.txt", "w") as txt_file:
    ...
    with open("files/properties/datasets.txt", "w") as txt_file:
        for line in list_of_properties_required:
            txt_file.write("".join(line) + "\n")

    with open('files/dictionaries/datasets.json', 'w') as f:
