...
def generate(dict_properties):
    ...
    with open("files/items/biosamples.txt", "w") as txt_file:
        for line in list_of_excel_items:
            txt_file.write("".join(line) + "\n")

    with open("files/definitions/biosamples.txt", "w") as txt_file:
    ...
    with open("files/properties/biosamples.txt", "w") as txt_file:
        for line in list_of_properties_required:
            txt_file.write("".join(line) + "\n")

    with open('files/dictionaries/biosamples.json', 'w') as f:
