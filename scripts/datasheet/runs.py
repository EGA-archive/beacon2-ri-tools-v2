...
def generate(dict_properties):
    ...
    with open("files/items/runs.txt", "w") as txt_file:
        for line in list_of_excel_items:
            txt_file.write("".join(line) + "\n")

    with open("files/definitions/runs.txt", "w") as txt_file:
    ...
    with open("files/properties/runs.txt", "w") as txt_file:
        for line in list_of_properties_required:
            txt_file.write("".join(line) + "\n")

    with open('files/dictionaries/runs.json', 'w') as f:
