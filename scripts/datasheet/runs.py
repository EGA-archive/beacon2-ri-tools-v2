...
def generate(dict_properties):
    ...
    with open('csv/templates/runs.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(list_of_excel_items)
        csvfile.close()

    with open("files/headers/runs.txt", "w") as txt_file:
        for line in list_of_excel_items:
            txt_file.write("".join(line) + "\n")

    with open("files/required/definitions/runs.txt", "w") as txt_file:
        for line in list_of_definitions_required:
            txt_file.write("".join(line) + "\n")

    with open("files/required/header_definitions/runs.txt", "w") as txt_file:
        for line in list_of_headers_definitions_required:
            txt_file.write("".join(line) + "\n")

    with open("files/required/properties/runs.txt", "w") as txt_file:
        for line in list_of_properties_required:
            txt_file.write("".join(line) + "\n")

    with open('files/deref_schemas/runs.json', 'w') as f:
